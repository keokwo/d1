    ...
    <BasicLayout>
      <header id="header" className="mb-10 md:flex md:items-start">
        <div className="flex-auto max-w-4xl">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl text-slate-900 dark:text-slate-200">
        ...
        <div className="relative z-10">
          ...
          <div className="flex mb-6 -mx-4 overflow-auto sm:-mx-6">
            <div className="flex-none min-w-full px-4 sm:px-6">
              <ul className="flex mb-px space-x-6 border-b border-slate-200 whitespace-nowrap dark:border-slate-200/5">
      ...
      <section className="relative">
        <h2 className="mb-3 text-xl font-bold tracking-tight text-slate-900 dark:text-slate-200">
          What to read next
        </h2>
        <div className="max-w-2xl mb-10 prose prose-slate xl:mb-0 dark:prose-dark">
          <p>
            Get familiar with some of the core concepts that make Tailwind CSS different from
            writing traditional CSS.
          </p>
        </div>
        <ul className="grid grid-cols-1 mt-10 gap-x-16 gap-y-8 xl:grid-cols-2 xl:gap-y-10">
          {readNext.map((item) => (
